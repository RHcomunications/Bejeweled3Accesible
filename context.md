...
- **Android (`android`)**: Release `android-v2026.08.24.11` (**Versión Definitiva con Paridad Total 1:1**) con TalkBack nativo, árbol de accesibilidad virtual de 64 nodos, Escuela de Audio, Opciones Zen, Modo Misión con Relicarios y Desafíos, diálogos accesibles nativos de perfil y físicas completas de Mariposas y Mina de Diamantes.
