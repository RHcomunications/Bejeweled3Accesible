...
- **Windows (`main`)**: Release `v2026.08.31.0` (Triple Auditoría: optimización de ciclo de vida de timers, liberación thread-safe de streams de BASS y barridos espaciales, y blindaje de recursos). Suite de tests unitarios 100% en verde.
