...
- **Windows (`main`)**: Release en desarrollo (Caja de Música con pistas auténticas MO3 y localización bilingüe, persistencia de atmósfera acústica 3D). Suite de tests unitarios completa (137/137 tests sin audio, 153/153 totales).
