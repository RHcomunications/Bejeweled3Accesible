...
namespace Bejeweled3Accessible.Engine
{
    ...
    public static class Localization
    {
        ...
        {
            // Loading Screen
            { "LoadingTitle", new Tuple<string, string>("Cargando Bejeweled 3... Versión 2026.08.26.10.", "Loading Bejeweled 3... Version 2026.08.26.10.") },
            ...
            // Menus
            { "AppTitle", new Tuple<string, string>("Bejeweled 3 Accesible - Versión 2026.08.26.10", "Bejeweled 3 Accessible - Version 2026.08.26.10") },
            ...
            { "SwapUp", new Tuple<string, string>("Mover Arriba", "Move Up") },
            { "SwapDown", new Tuple<string, string>("Mover Abajo", "Move Down") },
            { "SwapLeft", new Tuple<string, string>("Mover Izquierda", "Move Left") },
            { "SwapRight", new Tuple<string, string>("Mover Derecha", "Move Right") },
            ...
            { "GameReady", new Tuple<string, string>("Listo para jugar", "Ready to play") },
            { "EnterNameConfirm", new Tuple<string, string>("Aceptar", "OK") }
        };
