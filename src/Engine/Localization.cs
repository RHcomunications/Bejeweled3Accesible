...
namespace Bejeweled3Accessible.Engine
{
    ...
    public static class Localization
    {
        ...
        {
            // Loading Screen
            { "LoadingTitle", new Tuple<string, string>("Cargando Bejeweled 3... Versión 2026.08.11.3.", "Loading Bejeweled 3... Version 2026.08.11.3.") },
            ...
            // Menus
            { "AppTitle", new Tuple<string, string>("Bejeweled 3 Accesible - Versión 2026.08.11.3", "Bejeweled 3 Accessible - Version 2026.08.11.3") },
