...
namespace Bejeweled3Accessible.Engine
{
    ...
    public static class Localization
    {
        ...
        {
            // Loading Screen
            { "LoadingTitle", new Tuple<string, string>("Cargando Bejeweled 3... Versión 2026.08.11.2.", "Loading Bejeweled 3... Version 2026.08.11.2.") },
            ...
            // Menus
            { "AppTitle", new Tuple<string, string>("Bejeweled 3 Accesible - Versión 2026.08.11.2", "Bejeweled 3 Accessible - Version 2026.08.11.2") },
            ...
            { "BadgeInferno", new Tuple<string, string>("Inferno (Destruir gemas de fuego: Bronce 10, Plata 25, Oro 50, Platino 100)", "Inferno (Destroy flame gems: Bronze 10, Silver 25, Gold 50, Platinum 100)") },
            { "BadgeStellar", new Tuple<string, string>("Estelar (Destruir gemas estela: Bronce 5, Plata 15, Oro 30, Platino 60)", "Stellar (Destroy star gems: Bronze 5, Silver 15, Gold 30, Platinum 60)") },
            { "BadgeChromatic", new Tuple<string, string>("Cromático (Destruir hipercubos: Bronce 3, Plata 8, Oro 15, Platino 30)", "Chromatic (Destroy hypercubes: Bronze 3, Silver 8, Gold 15, Platinum 30)") },
