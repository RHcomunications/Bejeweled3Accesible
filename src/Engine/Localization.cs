...
namespace Bejeweled3Accessible.Engine
{
    ...
    public static class Localization
    {
        ...
        private static readonly Dictionary<string, Tuple<string, string>> _dict = new Dictionary<string, Tuple<string, string>>
        {
...
#else
            { "LoadingTitle", new Tuple<string, string>("Cargando Bejeweled 3... Versión 2026.09.07.1.", "Loading Bejeweled 3... Version 2026.09.07.1.") },
#endif
...
#else
            { "AppTitle", new Tuple<string, string>("Bejeweled 3 Accesible - Versión 2026.09.07.1", "Bejeweled 3 Accessible - Version 2026.09.07.1") },
#endif
            ...
            { "OptMusicBox", new Tuple<string, string>("Caja de Música: {0}", "Music Box: {0}") },
            { "MusicBoxAuto", new Tuple<string, string>("Automática", "Automatic") },
            { "MusicBoxLocked", new Tuple<string, string>("Bloqueada (Secreto)", "Locked (Secret)") },
            { "MusicBoxLockedHint", new Tuple<string, string>("La Caja de Música está bloqueada. Demuestra tu maestría alcanzando el rango de Anciano Bejeweliano o completando todas las 40 misiones de Quest.", "The Music Box is locked. Prove your mastery by reaching the rank of Elder Bejewelian or completing all 40 Quest missions.") },
            { "MusicTrackMainTheme", new Tuple<string, string>("Tema Principal", "Main Theme") },
            { "MusicTrackIntro", new Tuple<string, string>("Intro", "Intro") },
            { "MusicTrackClassic", new Tuple<string, string>("Modo Clásico", "Classic Mode") },
            { "MusicTrackLightning", new Tuple<string, string>("Modo Relámpago", "Lightning Mode") },
            { "MusicTrackZen", new Tuple<string, string>("Modo Zen", "Zen Mode") },
            { "MusicTrackButterflies", new Tuple<string, string>("Mariposas", "Butterflies") },
            { "MusicTrackPoker", new Tuple<string, string>("Póker", "Poker") },
            { "MusicTrackIceStorm", new Tuple<string, string>("Tormenta de Hielo", "Ice Storm") },
            { "MusicTrackQuest", new Tuple<string, string>("Misión: Búsqueda", "Quest Theme") },
            { "MusicTrackBuriedTreasure", new Tuple<string, string>("Misión: Tesoro Enterrado", "Quest: Buried Treasure") },
            { "MusicTrackTakeYourTime", new Tuple<string, string>("Misión: Tómate tu Tiempo", "Quest: Take Your Time") },
            { "MusicTrackTurnByTurn", new Tuple<string, string>("Misión: Turno a Turno", "Quest: Turn by Turn") },
            { "MusicTrackTimeBombs", new Tuple<string, string>("Misión: Bombas de Tiempo", "Quest: Time Bombs") },
            { "MusicTrackAmbientCoastal", new Tuple<string, string>("Ambiente: Costa", "Ambient: Coastal") },
            { "MusicTrackAmbientCrickets", new Tuple<string, string>("Ambiente: Grillos", "Ambient: Crickets") },
            { "MusicTrackAmbientForest", new Tuple<string, string>("Ambiente: Bosque", "Ambient: Forest") },
            { "MusicTrackAmbientOceanSurf", new Tuple<string, string>("Ambiente: Olas del Océano", "Ambient: Ocean Surf") },
            { "MusicTrackAmbientRainLeaves", new Tuple<string, string>("Ambiente: Lluvia en las Hojas", "Ambient: Rain Leaves") },
            { "MusicTrackAmbientWaterfall", new Tuple<string, string>("Ambiente: Cascada", "Ambient: Waterfall") },
